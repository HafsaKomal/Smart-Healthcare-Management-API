...
- [API Documentation](#api-documentation)
  ...
  - [Reports (Aggregation)](#reports-aggregation)
- [Indexing & Performance](#indexing--performance)
- [Hybrid Query (Mongo + SQL)](#hybrid-query-mongo--sql)
- [Security](#security)
- [Replica Set & High Availability](#replica-set--high-availability)
- [Testing](#testing)
- [Benchmarking Tips](#benchmarking-tips)
- [Postman/Swagger](#postmanswagger)
- [License](#license)
...
Create **.env** (see [Configuration](#configuration)).
...
Example:
```bash
curl -X POST http://127.0.0.1:5000/api/auth/login  -H "Content-Type: application/json"  -d '{"email":"ali@example.com","password":"Passw0rd!"}'
```
...
- Example service flow:
  1) Aggregate Mongo prescriptions by disease.
  2) For each disease/appointment, query SQL `Billing` to compute average total cost.
